(() => {
  ...
  function se(e) {
    ...
    function f(e) {
      ...
      if (
        ...
        !t.mouseEntered && !l[0].contains(s.target) && !r.releaseOnEdges)
      )
        return !0;
    ...
    i("init", () => {
      !t.params.mousewheel.enabled && t.params.cssMode && S(),
        t.params.mousewheel.enabled && T();
    }),
      i("destroy", () => {
        t.params.cssMode && T(), t.mousewheel.enabled && S();
      }),
      Object.assign(t.mousewheel, { enable: T, disable: S });
  }
  function ie(e) {
  ...
  window.addEventListener("load", function (e) {
    ne(),
      document.querySelector(".main__slide") &&
        new te(".main__slider", {
          modules: [ie, se],
          direction: "vertical",
          slidesPerView: 1,
          ...
          simulateTouch: !0,
          speed: 1500,
          mousewheel: { invert: !1, ForceToAxis: !0 },
        });
  });
  let re = !1;
  setTimeout(() => {
