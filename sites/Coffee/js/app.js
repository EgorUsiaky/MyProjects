    ...
    de(),
      document.querySelector(".swiper") &&
        (new oe(".favorite__slider", {
          ...
          speed: 800,
          navigation: {
            nextEl: ".favorite .more-item_next",
            prevEl: ".favorite .more-item_prev",
          },
          autoHeight: !1,
          breakpoints: { 320: { touchRatio: 1 }, 1300: { touchRatio: 0 } },
        }),
        new oe(".combo__slider", {
          modules: [le],
          observer: !0,
          observeParents: !0,
          slidesPerView: "auto",
          ...
          speed: 800,
          navigation: {
            nextEl: ".combo .more-item_next",
            prevEl: ".combo .more-item_prev",
          },
          autoHeight: !1,
          breakpoints: { 320: { touchRatio: 1 }, 1300: { touchRatio: 0 } },
        }));
